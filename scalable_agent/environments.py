...
class FlowEnvironment(object):
  ...
  def initial(self):
    ...
    with tf.name_scope('flow_environment_initial'):
      ...
      initial_state = (initial_flow, initial_info) # Not sure what this is for. Also why not put initial_state inside the control_dependencies context? Does this also works?
